...
public class ContactProfileDto {
  ...
  public ContactProfileDto contactId(@javax.annotation.Nullable String contactId) {
  ...
  public ContactProfileDto firstName(@javax.annotation.Nullable String firstName) {
  ...
  public ContactProfileDto lastName(@javax.annotation.Nullable String lastName) {
  ...
  public ContactProfileDto organization(@javax.annotation.Nullable String organization) {
  ...
  public ContactProfileDto email(@javax.annotation.Nullable String email) {
    this.email = email;
    return this;
  }
  ...
  public ContactProfileDto phone(@javax.annotation.Nullable String phone) {
    this.phone = phone;
    return this;
  }
  ...
  public ContactProfileDto addressLine1(@javax.annotation.Nullable String addressLine1) {
  ...
  public ContactProfileDto addressLine2(@javax.annotation.Nullable String addressLine2) {
  ...
  public ContactProfileDto city(@javax.annotation.Nullable String city) {
    this.city = city;
    return this;
  }
  ...
  public ContactProfileDto stateProvince(@javax.annotation.Nullable String stateProvince) {
  ...
  public ContactProfileDto postalCode(@javax.annotation.Nullable String postalCode) {
  ...
  public ContactProfileDto countryCode(@javax.annotation.Nullable String countryCode) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.contactId, contactProfileDto.contactId) &&
        Objects.equals(this.firstName, contactProfileDto.firstName) &&
        Objects.equals(this.lastName, contactProfileDto.lastName) &&
        Objects.equals(this.organization, contactProfileDto.organization) &&
        Objects.equals(this.email, contactProfileDto.email) &&
        Objects.equals(this.phone, contactProfileDto.phone) &&
        Objects.equals(this.addressLine1, contactProfileDto.addressLine1) &&
        Objects.equals(this.addressLine2, contactProfileDto.addressLine2) &&
        Objects.equals(this.city, contactProfileDto.city) &&
        Objects.equals(this.stateProvince, contactProfileDto.stateProvince) &&
        Objects.equals(this.postalCode, contactProfileDto.postalCode) &&
        Objects.equals(this.countryCode, contactProfileDto.countryCode);
  }

  @Override
  public int hashCode() {
    return Objects.hash(contactId, firstName, lastName, organization, email, phone, addressLine1, addressLine2, city, stateProvince, postalCode, countryCode);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("contactId", "firstName", "lastName", "organization", "email", "phone", "addressLine1", "addressLine2", "city", "stateProvince", "postalCode", "countryCode"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ContactProfileDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ContactProfileDto is not found in the empty JSON string", ContactProfileDto.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ContactProfileDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ContactProfileDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
